...
def custom_logger():
    ...
    # 2.) Create the logging object and pass the log_name in it
    logger = logging.getLogger(log_name)

    # 3.) Set the Log level
    logger.setLevel(logging.DEBUG)

    # 4.) Create the file_handler to save the logs in the file
    file_handler = logging.FileHandler("../reports/Code2lead.log", mode='a')
